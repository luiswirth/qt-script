...
#let symbol-equations = (
  ...
  "se-2d": $"SE"_"2D"$,
  "h-entries": $h_(i i j j)$,
  "H-RS": $H_"RS"$,
  "alpha-beta": $alpha_i, beta_(i_1 i_2)$,
  "GF-2d": $G^R_"2D"$,
  "rgf-2d": [2-D recursion],
  "basis-expansion": $G^R (phi.alt)$,
  "basis-conditions": [basis conditions],
  "GF-transform": $U tilde(G)^R U^T$,
  "GF-MS": $tilde(G)^R$,
  "lambda-gamma": $lambda_i, gamma_(i_1 i_2)$,
  "mode-problem": $alpha_i phi.alt_n$,
  "epsilon-i": $epsilon_i$,
  "H-MS": $H_"MS"$,
  "cms-recursion": [CMS recursion],
  "ums-modes": $phi.alt_n (y)$,
  "ums-ansatz": $phi(x, y)$,
  "ums-1d": $"SE"_n$,
  "ums-GF": $tilde(G)^R_n$,
  "separable-potential": $V_1 + V_2$,
  "ums-reconstruct": $G^R (phi.alt_n)$,
  "n-reconstruct": $n(x, y)$,
)
